        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <span className="text-xl font-bold text-orange-400">Artist Dashboard</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          {stats.map((stat, index) => (
            <div key={index} className="bg-gray-900 rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm text-orange-400">{stat.label}</p>
        ...
        <div className="bg-gray-900 rounded-lg shadow">
          <div className="p-6 border-b border-gray-700">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-bold text-orange-400">Daftar Produk</h2>
              <button 
                onClick={() => {
                  resetForm();
                  setShowForm(true);
